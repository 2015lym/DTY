...
#import "MyControl.h"
@interface QRCodeViewController_WYXC ()<AVCaptureMetadataOutputObjectsDelegate>
{
    float jing;
    float  wei;
    NSString *addressStr;
...
@implementation QRCodeViewController_WYXC
...
//    url=[NSString stringWithFormat:@"%@?liftNum=%@",url,LiftNum];
    [XXNet PostURL:WYXC_GetPropertyStep header:nil parameters:dicHeader succeed:^(NSDictionary *data) {
