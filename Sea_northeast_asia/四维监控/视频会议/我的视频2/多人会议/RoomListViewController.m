...
//    [self.view addSubview:CourseTableview.tableView];
    ...
    UIImage *userImage = [UIImage imageNamed:@"meeting"];
    ...
    UILabel *label1 = [MyControl createLabelWithFrame:CGRectMake(0, CGRectGetMaxY(userImageView.frame)+10, SCREEN_WIDTH, 30) Font:18 Text:@"视频会议..."];
    label1.textAlignment = NSTextAlignmentCenter;
    label1.textColor = [UIColor whiteColor];
    [bigView addSubview:label1];
    
    
    UIButton *agreeBtn = [MyControl createButtonWithFrame:CGRectMake(60, SCREEN_HEIGHT-100, 80, 80) imageName:nil bgImageName:nil title:@"接受" SEL:@selector(BtnClick:) target:self];
    agreeBtn.tag=100;
    ...
    agreeBtn.layer.cornerRadius=80/2.0;
    [bigView addSubview:agreeBtn];
    
    
    UIButton *stopBtn = [MyControl createButtonWithFrame:CGRectMake(SCREEN_WIDTH-140, SCREEN_HEIGHT-100, 80, 80) imageName:nil bgImageName:nil title:@"拒绝" SEL:@selector(BtnClick:) target:self];
    stopBtn.tag=101;
    [stopBtn setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
    [stopBtn setBackgroundColor:[UIColor redColor]];
    stopBtn.layer.masksToBounds=YES;
    stopBtn.layer.cornerRadius=80/2.0;
...
{
//test_new    return [NTESNetcallManager setBypassStreamingEnabled:enabled];
        return YES;
}
