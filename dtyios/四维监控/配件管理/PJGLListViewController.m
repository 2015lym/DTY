...
@interface PJGLListViewController ()<UIWebViewDelegate> {
    WKWebView *webview;
}

@end

@implementation PJGLListViewController
...
{
    QRCodeViewController_PJGL *physical = [[QRCodeViewController_PJGL alloc] initWithNibName:@"QRCodeViewController_JX" bundle:nil];
