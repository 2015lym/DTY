...
#import "QRCodeViewController_SPJ.h"
#import <AVFoundation/AVFoundation.h>
#import "CommonUseClass.h"

#import "MyControl.h"
@interface QRCodeViewController_SPJ ()<AVCaptureMetadataOutputObjectsDelegate>
{
    float jing;
    float  wei;
    NSString *addressStr;
...
@implementation QRCodeViewController_SPJ
...
-(void)gotoDetail
{
    ...
    [XXNet GetURL:url header:nil parameters:dicHeader succeed:^(NSDictionary *data) {
        ...
        else
        {
            ...
            SPJSaveViewController *ctvc=[[SPJSaveViewController alloc] init];
            ctvc.Title=@"视频机绑定";
