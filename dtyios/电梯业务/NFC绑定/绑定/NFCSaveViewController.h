...
@import CoreNFC;
@interface NFCSaveViewController : UIViewController<NFCNDEFReaderSessionDelegate,BMKMapViewDelegate,BMKLocationServiceDelegate,BMKGeoCodeSearchDelegate>
{
    UIView *headview;
    UILabel *dtBianHao_2;
    UILabel *dtWeiBao_2;
