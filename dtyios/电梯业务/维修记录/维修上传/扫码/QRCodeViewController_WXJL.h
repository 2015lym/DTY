...
@interface QRCodeViewController_WXJL : UIViewController<BMKMapViewDelegate,BMKLocationServiceDelegate,BMKGeoCodeSearchDelegate>
{
    UIView *viewLast;
