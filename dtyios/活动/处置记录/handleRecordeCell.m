...
#import "handleRecordeCell.h"
#import "warningElevatorModel.h"
@interface handleRecordeCell ()

@end

@implementation handleRecordeCell
- (void)awakeFromNib {
    [super awakeFromNib];
    // Initialization code
}
...
- (BOOL)configTableViewCell:(id)aObject_entity index_row:(int)aIndex_row count:(int)aCount_source;
{
    ...
    //_labTime.text=[cTime objectAtIndex:1];
    ...
    _labLine.frame=CGRectMake(_labLine.frame.origin.x, _labLine.frame.origin.y, bounds_width.size.width-55,_labLine.frame.size.height);
    ...
    _labAddr.frame=CGRectMake(_labAddr.frame.origin.x, _labAddr.frame.origin.y, bounds_width.size.width-73-52,_labAddr.frame.size.height);
     //_labTotalTime.frame=CGRectMake(bounds_width.size.width-70-53, _labTotalTime.frame.origin.y, 70,_labTotalTime.frame.size.height);
    //_labDate.frame=CGRectMake(bounds_width.size.width-70-53, _labDate.frame.origin.y, 70,_labDate.frame.size.height);
    //_labTime.frame=CGRectMake(bounds_width.size.width-70-53, _labTime.frame.origin.y, 70,_labTime.frame.size.height);
    return YES;
}
