...
//
                      ...
                      for (NSDictionary * dic in allTags) {
                          ...
                          if([[dic objectForKey:@"CheckType"] intValue]==_floorNumber)
                          {
                              ...
                              NSString *curr=[NSString stringWithFormat:@"%@",[dic objectForKey:@"StepName"]];
                              [dic1 setValue:curr forKey:@"Name"];
                             [titleArray addObject:dic1];
                              */
...
//                      NSLog(@"%d",[floorNumber intValue]);
//                      
//                 for (int i = 0; i < titleArray.count; i ++) {
//                     
//                     if([[allTags[i] valueForKey:@"CheckType"] intValue]==[floorNumber intValue]){
//                     
//                         [titleArray addObject:[NSString stringWithFormat:@"%d、%@",i,[allTags[i] objectForKey:@"StepName"]]];
//                     }
//                 }
...
//                              
//                              if ([titleArray[i] intValue]>[titleArray[j] intValue]) {
//                                  
//                                  //交换
//                                  
