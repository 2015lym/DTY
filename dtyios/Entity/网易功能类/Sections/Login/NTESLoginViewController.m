...
- (void)configNav{
    ...
    [backBtn setTitleColor:UIColorFromRGB(0x2294ff) forState:UIControlStateNormal];
    [backBtn setBackgroundImage:[UIImage imageNamed:@"btn_round_rect_normal"] forState:UIControlStateNormal];
    [backBtn setBackgroundImage:[UIImage imageNamed:@"btn_round_rect_pressed"] forState:UIControlStateHighlighted];
...
//                                          [[NTESPageContext sharedInstance] setupMainViewController];
                                          ...
                                          NTESEnterRoomViewController *vc = [[NTESEnterRoomViewController alloc]initWithNibName:nil bundle:nil];
