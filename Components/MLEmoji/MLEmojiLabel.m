...
const CGFloat kEmojiWidthRatioWithLineHeight = 1.3;//和字体高度的比例

const CGFloat kEmojiOriginYOffsetRatioWithLineHeight = 0.30; //表情绘制的y坐标矫正值，和字体高度的比例，越大越往下
...
+ (NSDictionary *)emojiDictionary {
    ...
    static dispatch_once_t onceToken;
	dispatch_once(&onceToken, ^{
	    NSString *emojiFilePath = [[[NSBundle mainBundle] resourcePath] stringByAppendingPathComponent:@"key_face.plist"];
...
//    UIColor *commonLinkColor;
//    if (self.colorSendReceive)
//        commonLinkColor= [UIColor whiteColor];
//    else
//        commonLinkColor = [UIColor colorWithRed:130.000f/255.000f green:130.000f/255.000f blue:130.000f/255.000f alpha:1.000f];
//    
//    
//    //点击时候的背景色
...
//            NSString *stremoji=[NSString stringWithFormat:@"[%@]",emojiKey.string];
//            NSAttributedString *nsstr=[[NSAttributedString alloc]initWithString:[Util emojiImageRange:stremoji]];
//			[attrStr appendAttributedString:nsstr];
