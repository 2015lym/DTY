            ...
            [UIView animateWithDuration:0.3 animations:^{
                if (_saveIndex==i) {
                    ...
                    if (saveItems.center.x==self.frame.size.width/2) {
                        ...
                        [_showInfoView updateFrameTo:CGRectMake(p.x, p.y, _showInfoView.frame.size.width, _showInfoView.frame.size.height) andBGColor:colors[i%colors.count] andShowContentString:[NSString stringWithFormat:@"%@",_countArr[i]]];
