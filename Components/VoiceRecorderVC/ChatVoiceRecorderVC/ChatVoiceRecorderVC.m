...
- (void)beginRecordByFileName:(NSString*)_fileName;{
    ...
    CGRect rect=CGRectMake(0, 0, app.window.frame.size.width, app.window.frame.size.height);
...
- (void)touchMoved:(CGPoint)_point{
    ...
    {
        [recorderView prepareToDelete:self.isTouch];
    }
...
{
    [self performSelector:@selector(stop_recorder) withObject:self afterDelay:1];
}
